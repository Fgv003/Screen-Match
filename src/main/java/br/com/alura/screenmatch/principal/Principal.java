...
public class Principal {
    ...
    private void buscarEpisodioPorSerie(){
        listarSeriesBuscadas();
        System.out.println("Escolha pelo nome a série que deseja ver os episódios ");
        var serieBuscada = leitura.nextLine();


        Optional<Serie> serie = series.stream().filter(s -> s.getTitulo().toLowerCase()
                .contains(serieBuscada.toLowerCase())).findFirst();
        ...
        if (serie.isPresent()) {
            ...
            System.out.println("Episódios não encontrados!");
        }
    }
